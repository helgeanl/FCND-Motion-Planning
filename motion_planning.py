...
from planning_utils import a_star, heuristic, create_grid, prune_path, plot_grid
...
class MotionPlanning(Drone):
    ...
    def set_goal(self, lat, long, alt):
        self.global_goal = [long, lat, alt]
...
if __name__ == "__main__":
    ...
    drone.set_goal(args.lat, args.long, args.alt)
    time.sleep(1)
